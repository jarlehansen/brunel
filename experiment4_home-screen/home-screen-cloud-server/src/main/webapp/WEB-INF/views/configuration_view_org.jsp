          ...
          <blockquote>
			...
			<stripes:form beanclass="ac.uk.brunel.cloudhomescreen.presentation.beans.ConfigurationActionBean" focus="">
              ...
              <tr>
                ...
                <tr>
                    <td height="35" colspan="3"><h3>Push sources</h3></td>
                </tr>

				<c:forEach items="${actionBean.pushSources}" var="configuration">
				<tr>
                    <td width="115"><img src="/images/${configuration.shortName}.png" width="86" height="86" /></td>
	                <td width="240"><h5>${configuration.source}</h5></td>
	                <td><stripes:checkbox name="configuration" value="${configuration.source}" /></td>
	             </tr>
              	</c:forEach>
